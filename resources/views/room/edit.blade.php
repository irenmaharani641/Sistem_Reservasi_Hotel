            ...
            <div class="row g-3">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('room_number') is-invalid @enderror" type="text" id="room_number"
                        name="room_number" required value="{{ old('room_number', $room->room_number) }}">
                    @error('room_number')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('price_per_night') is-invalid @enderror" type="number" step="0.01" id="price_per_night"
                        name="price_per_night" required value="{{ old('price_per_night', $room->price_per_night) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('is_available') is-invalid @enderror" id="is_available" name="is_available" required>
                        <option value="1" @selected(old('is_available', $room->is_available) == 1)>Tersedia</option>
                        <option value="0" @selected(old('is_available', $room->is_available) == 0)>Tidak Tersedia</option>
                    </select>
                    @error('is_available')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
